        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="nav nav-tabs">
                    ...
                    <li class=""><a href="pending_orders.php"><i class="fa fa-file"></i> Pending Order</a> </li>
                    <li class=""><a href="order_completion.php"><i class="fa
                    fa-file"></i>Successfull Orders</a>
                    </li>
                </ul>
            </nav>
...
//                                    var_dump($userDetails);
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left!important;">
                                        <a href="order_process.php?status=approve" class="btn
                                        btn-primary">Approve</a>
                                        <a href="order_process.php?status=reject" class="btn
                                        btn-danger">Reject</a>
                                    </td>
                                </tr>
                                <?php
