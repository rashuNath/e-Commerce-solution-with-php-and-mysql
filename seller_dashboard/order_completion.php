            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="nav nav-tabs">
                    ...
                    <li class=""><a href="admin_dashboard.php"><i class="fa fa-file"></i>
                            Overview</a> </li>
                    <li><a href="pending_orders.php"><i class="fa fa-file"></i> Pending Order</a>
                    </li>
                    <li class="active"><a data-toggle="tab" href="#pending-order"><i class="fa
                    fa-file"></i> Successfull Orders</a> </li>
            ...
            <div class="tab-content">
                ...
                <div  class="tab-pane active" id="pending-order">
                    ...
                    <div class="card-body">
                        <?php
                        $objectAuth = new Auth();
                        $viewOrders = $objectSeller->viewDelivered();
                        if($viewOrders!=false){
                            ?>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>Phone Number</th>
                                        <th>Amount</th>
                                        <th style="text-align: left">Delivery Status</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
...
//                                    var_dump($userDetails);
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left"><?php if
                                                ($singleOrder->delivered=="yes"){
                                                    ?>
                                                    <span class="badge
                                                    badge-primary">Delivered</span>
                                                <?php
                                                }else{
                                                    ?>
