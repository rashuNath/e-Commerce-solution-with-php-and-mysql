...
if(isset($_GET['categoryId'])){
    $objectSeller->setCategoryGetData($_GET);

    $productsByCategory = $objectSeller->productsByCategoryId();
}else{
//    Utility::var_dump($_POST);
    $_SESSION['categoryId'] = $_POST['categoryId'];
    $_SESSION['categoryName'] = $_POST['categoryName'];
    $objectSeller->setCategoryGetData($_SESSION);
    $productsByCategory = $objectSeller->productsByCategoryId();
}
...
//                            echo $low_price;
                        $products = $objectSeller->product_filter_by_price_by_category($low_price, $high_price, $categoryId);
                        if($products===false){
                            ?>
