                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                                    <?php
                                        if(isset($_POST['low_price'])){
                                            ?>
                                            <input type="text" id="low-price" name="low_price" class="form-control" style="border:1px solid #838383!important; margin-bottom: 8px!important;" value = "<?php echo $_POST['low_price'] ?>">
                                            Highest
                                            <input type="text" id="high-price" name="high_price" class="form-control" style="border:1px solid #838383!important; margin-bottom:8px!important;" value = "<?php echo $_POST['high_price'] ?>">
                                    <?php
                                        }else{
                                            ?>
                                            Lowest
...
//                    echo "price filter has not been setted!";
